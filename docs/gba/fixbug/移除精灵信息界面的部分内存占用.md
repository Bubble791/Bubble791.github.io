...
After all that, head on to [include/pokemon.h](../blob/master/include/pokemon.h) to reduce this
```c
...
Along with in [src/pokemon_summary_screen.c](../blob/master/src/pokemon_summary_screen.c)
